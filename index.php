                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-file"></i> Laporan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index.php?page=laporan_peminjaman_data">Laporan Peminjaman Buku</a></li>
                      <li><a href="index.php?page=laporan_pengembalian_buku">Laporan Pengembalian Buku</a></li>
                    </ul>
                  </li>
                  <?php }?>
        ...
        case 'edit_mhs_save':
          ...
          case 'edit_mhs_save':
            ...
            break;
          	...
          	case 'peminjaman_data':
              # code...
              include 'peminjaman_data.php';
              break;
            case 'tambah_camera':
              # code...
              include 'tambah.php';
            ...
            case 'edit_mhs_save':
              ...
              break;
            	...
            	case 'pengembalian_data':
                # code...
                include 'pengembalian_data.php';
                break;
              case 'tambah_camera':
                # code...
                include 'tambah.php';
              ...
              case 'edit_mhs_save':
                ...
                case 'laporan_peminjaman_data':
                  # code...
                  include 'laporan_pinjam_buku.php';
                  break;
                case 'tambah_camera':
                  # code...
                  include 'tambah.php';
                ...
                case 'edit_mhs_save':
                  ...
                  case 'laporan_pengembalian_buku':
                    # code...
                    include 'laporan_pengembalian_buku.php';
                    break;
                  case 'tambah_camera':
                    # code...
                    include 'tambah.php';
