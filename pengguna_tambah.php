  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		<center><font size="6" face="Helvetica">Tambah Data Pengguna</font></center>
		<hr>
    ...
    <form enctype="multipart/form-data" method="POST" action="pengguna_tambah_2.php">
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">Id Pengguna</label>
				<div class="col-md-6 col-sm-6 ">
					<input type="text" name="id_pengguna" class="form-control" size="4" required>
				</div>
			</div>
      <div class="item form-group">
